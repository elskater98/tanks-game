...
void TexturesUtils::readJPEG(char *filename, unsigned char **image, int *width, int *height)
{
...
void TexturesUtils::loadTexture(char *filename, int dim)
{
    // https://github.com/hatsyio/Pacman_CPP
    ...
    TexturesUtils::readJPEG(filename, &buffer, &width, &height);
